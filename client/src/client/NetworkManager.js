export class NetworkManager {
  constructor() {
    ...
    // VITE_WS_URL = WebSocket URL (e.g. wss://xxx.ngrok-free.app/ws). VITE_API_URL = HTTP base for /rooms (e.g. https://xxx.ngrok-free.app).    const env = typeof import.meta !== "undefined" ? import.meta.env : {};
